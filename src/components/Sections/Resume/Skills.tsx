  ...
  return (
    <div className="rounded-2xl border border-neutral-200 bg-white p-5 shadow-sm">
      <div className="mb-4 flex items-center gap-3">
        ...
        <span className="text-lg font-semibold text-neutral-800">{name}</span>
      </div>
...
export const Skill: FC<{skill: SkillType}> = memo(({skill}) => {
  ...
  return (
    <div className="group relative">
      <div className="flex items-center gap-2 rounded-full border border-neutral-200 bg-white px-3 py-2 shadow-sm transition duration-200 hover:-translate-y-0.5 hover:border-orange-300 hover:shadow-md">
      ...
      <div className="pointer-events-none absolute left-1/2 top-full z-10 mt-2 w-max max-w-[180px] -translate-x-1/2 scale-95 rounded-xl border border-neutral-200 bg-neutral-900 px-3 py-2 text-sm text-white opacity-0 shadow-xl transition-all duration-200 group-hover:scale-100 group-hover:opacity-100">
